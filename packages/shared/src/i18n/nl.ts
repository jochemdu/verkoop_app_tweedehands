...
export const nl = {
  ...
  dashboard: {
    ...
    emptyTitle: "Nog niks geïndexeerd",
    emptyDesc: "Voeg je eerste producten toe via bulk-upload of de mobiele app om je voorraad hier te zien.",
    heroRealized: "Gerealiseerd",
    heroPotential: "Voorraad-potentieel",
    thisWeekLabel: "deze week",
    noTitle: "(geen titel)",
    view: "Bekijk",
  ...
  listings: {
    ...
    emptyPost: " MCP tool.",
    emptyTitle: "Nog geen advertenties",
    emptyDesc: "Genereer een advertentie-concept via Claude en review het hier voordat je publiceert.",
    colSticker: "Sticker",
    colTitle: "Titel",
  ...
  product: {
    ...
    cameraOpen: "Camera",
    cameraTitle: "Foto maken",
    cameraSnap: "Vastleggen",
    cameraFlip: "Camera draaien",
    cameraUploadN: "{count} toevoegen",
    cameraClose: "Sluiten",
    cameraDenied: "Geen cameratoegang. Sta het toe in je browser en probeer opnieuw.",
    cameraUnsupported: "Camera wordt niet ondersteund door deze browser.",
    cameraEmpty: "Nog geen foto's. Tik op Vastleggen.",
    cameraRemove: "Verwijderen",
  ...
  mobile: {
    ...
    invalidStickerMsg: "Moet 4 cijfers zijn, evt. met prefix (bijv. 0042 of MEM0001).",
    ...
    stickerIdLabel: "Sticker-ID",
    stickerIdPlaceholder: "0042 of MEM0001 (of laat leeg voor OCR)",
    ...
    addPhotoTitle: "Foto's toevoegen",
    addPhotoCamera: "Camera",
    addPhotoGallery: "Galerij",
    addPhotoCancel: "Annuleren",
    addPhotoUploading: "Foto's uploaden…",
    addPhotoDone: "{count} foto('s) toegevoegd",
    addPhotoFail: "Foto's toevoegen mislukt",
    noTitle: "(geen titel)",
